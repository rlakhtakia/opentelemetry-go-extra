module github.com/rlakhtakia/opentelemetry-go-extra/otelzap/example

go 1.19

replace github.com/rlakhtakia/opentelemetry-go-extra/otelzap => ./..
...
require (
	github.com/rlakhtakia/opentelemetry-go-extra/otelzap v0.2.2
	go.opentelemetry.io/otel v1.16.0
	go.uber.org/zap v1.24.0
)

require github.com/rlakhtakia/opentelemetry-go-extra/otelplay v0.2.2
